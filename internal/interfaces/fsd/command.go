...
var (
	...
	SwitchVisualPilot    = ClientCommand("$SF")
	VisualPilotStop      = ClientCommand("#ST")
	VisualPilotPeriodic  = ClientCommand("#SL")
	VisualPilotPosUpdate = ClientCommand("^")
	Unknown              = ClientCommand("*UN")
)
